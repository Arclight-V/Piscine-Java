...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
    ...
    public Optional<Message> findById(Long id) {
        ...
        try {
            PreparedStatement preparedStatement = dataSource.getConnection().prepareStatement(selectMessageId);
            ...
            preparedStatement = dataSource.getConnection().prepareStatement(selectUserId);
